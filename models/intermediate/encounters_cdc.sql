...
WITH source AS (
    SELECT
        ...
        CASE 
            ...
            WHEN "Encounter_type" = 'WIMC meeting' THEN (observations::jsonb ->> 'Date of WIMC meeting')::date
            WHEN "Encounter_type" = 'Jal Chaupal' THEN (observations::jsonb ->> 'Date of jal chaupal')::date
            WHEN "Encounter_type" = 'Water Quality testing' THEN (observations::jsonb ->> 'Date of testing')::date
            WHEN "Encounter_type" = 'Tank Cleaning' THEN (observations::jsonb ->> 'Date of tank cleaning')::date
